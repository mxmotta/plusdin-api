...
RUN apk --no-cache add php7 php7-fpm php7-pdo_mysql php7-json php7-openssl php7-curl \
    ...
    php7-mbstring php7-gd php7-simplexml php7-tokenizer php7-fileinfo php7-xmlwriter php7-redis php7-pecl-imagick \
    file imagemagick ghostscript nginx curl redis

# Configure nginx
COPY environment/nginx.conf /etc/nginx/conf.d/rocket.conf
